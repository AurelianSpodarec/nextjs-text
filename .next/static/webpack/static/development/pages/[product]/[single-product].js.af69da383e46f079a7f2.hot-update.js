  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          query = ctx.query;
          console.log("Query Single Product", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_7__["default"]);
          return _context.abrupt("return", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_7__["default"].get("/wp-json/route/v1/product/slug=".concat(ctx.query['single-product'])) // return WooCommerce.get(`products/${ctx.query['single-product']}`)
...
//# sourceMappingURL=[single-product].js.af69da383e46f079a7f2.hot-update.js.map