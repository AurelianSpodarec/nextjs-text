...
function SingleProduct(_ref) {
  ...
  console.log("Product", product, product.variations[0].variation_gallery_images);
  return __jsx("div", {
    __self: this,
    __source: {
  ...
  }, "Price: ", product.price), product.variations[0].variation_gallery_images.map(function (product, index) {
    return __jsx(_material_ui_core_CardMedia__WEBPACK_IMPORTED_MODULE_4__["default"], {
...
//# sourceMappingURL=[single-product].js.b6f4934465d04413757d.hot-update.js.map