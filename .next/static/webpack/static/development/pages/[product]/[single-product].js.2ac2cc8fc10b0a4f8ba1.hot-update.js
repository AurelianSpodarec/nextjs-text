...
function ChooseColor(colors) {
  ...
  if (!colors) return "loda:;";
  return "s"; // return colors.map((color, index) => {
  //     <button style={{ height: '50px', width: '50px', baackgroundColor: `${color}` }}>
  //     </button>
  // })
}
...
function SingleProduct(_ref) {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(),
      ...
      setSelectedcolor = _useState[1]; // if (!product) return "loading"
  ...
  })), product.variations[0].variation_gallery_images.map(function (product, index) {
    return __jsx("img", {
...
//# sourceMappingURL=[single-product].js.2ac2cc8fc10b0a4f8ba1.hot-update.js.map