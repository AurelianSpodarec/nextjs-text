...
function SingleProduct(_ref2) {
  ...
  function getColor() {
    product.variations.map(function (object, index) {
      console.log("sdsds", colors.includes(object.attributes.attribute_pa_color) === false);

      if (colors.includes(object.attributes.attribute_pa_color) === false) {
        setColors(function (colors) {
          return [].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(colors), [object.attributes.attribute_pa_color]);
        });
      }

      return; //     if (colors exist dont add it else add)
...
//# sourceMappingURL=[single-product].js.408d1dc6750eed5f4f55.hot-update.js.map