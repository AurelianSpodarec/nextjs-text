...
function getColors(variation) {
  ...
  variation.variations.map(function (item, index) {
    setColors.apply(void 0, Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(colors).concat([item.attributes.attribute_pa_color]));
  }); // return colors;
}
...
function SingleProduct(_ref) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(),
      ...
      setSelectedcolor = _useState2[1]; // if (!product) return "loading"


  console.log(getColors(product));
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    console.log(getColors(product)); // product.variations.map((item, index) => {
...
//# sourceMappingURL=[single-product].js.b06860510eb8f72a4cad.hot-update.js.map