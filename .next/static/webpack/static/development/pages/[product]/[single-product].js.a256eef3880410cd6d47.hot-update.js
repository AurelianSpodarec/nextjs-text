...
function SingleProduct(_ref2) {
  ...
  function getColor() {
    product.variations.map(function (object, index) {
      ...
      if (obj.includes(object.attributes.attribute_pa_color)) {
        return;
      } else {
        obj.push(object.attributes.attribute_pa_color); // setColors(colors => [...colors, object.attributes.attribute_pa_color])
      }
...
//# sourceMappingURL=[single-product].js.a256eef3880410cd6d47.hot-update.js.map