...
function SingleProduct(_ref2) {
  ...
  var classes = useStyles(); // console.log("Product", product)
  ...
  }, "Name: ", productData.variations[0].name), __jsx("div", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 78,
  ...
  }, "Price: ", productData.variations[0].price), productData.variations[0].variation_gallery_images.map(function (product, index) {
    return __jsx("img", {
...
//# sourceMappingURL=[single-product].js.66ebe1ff7971bbd93fad.hot-update.js.map