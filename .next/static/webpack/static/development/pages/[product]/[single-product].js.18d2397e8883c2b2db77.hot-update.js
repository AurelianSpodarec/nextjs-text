    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_7__["default"].get("products/".concat(ctx.query['single-product'])) // return WooCommerce.get(`products/${ctx.query['single-product']}`)
...
//# sourceMappingURL=[single-product].js.18d2397e8883c2b2db77.hot-update.js.map