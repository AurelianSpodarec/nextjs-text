...
function SingleProduct(_ref2) {
  ...
  function getSizes() {
    var obj = [];
    product.variations.map(function (object, index) {
      // filter if color matches, get the objetc attribute
      // console.log
      ...
      } // if (obj.includes(object.attributes.attribute_pa_size) === false) {
      // }
  ...
  return __jsx("div", {
    ...
    return __jsx("button", {
      onClick: function onClick() {
        return setSelectedcolor(object);
      },
      key: index,
      style: {
...
//# sourceMappingURL=[single-product].js.7decb9f320c7d43586bd.hot-update.js.map