...
function SingleProduct(_ref2) {
  ...
  }, "Price: ", productData.variations[productID].display_price), productData.map(function (object, index) {
    return __jsx("button", {
      onClick: function onClick() {
        return setProductID(index);
      },
      key: index,
      style: {
        height: '50px',
        width: '50px',
        backgroundColor: "".concat(getColors(productData))
      },
      __self: _this2,
      __source: {
        fileName: _jsxFileName,
  ...
  }), productData.variations[productID].variation_gallery_images.map(function (product, index) {
    return __jsx("img", {
...
//# sourceMappingURL=[single-product].js.ddd55e33ecc1026ecbd3.hot-update.js.map