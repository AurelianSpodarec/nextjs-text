  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          query = ctx.query;
          console.log("assdsds", query['single-product']); // return WooCommerce.get(`products/${ctx.query['single-product']}`)

          return _context.abrupt("return", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_7__["default"].get("products/square-shirt").then(function (response) {
            return {
...
//# sourceMappingURL=[single-product].js.88258398523a2005ee3d.hot-update.js.map