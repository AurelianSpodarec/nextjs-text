...
function SingleProduct(_ref2) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(product),
      productData = _useState3[0],
      setProductData = _useState3[1]; // if (!product) return "loading"
  // setProductId
  // useEffect(() => {
  //     // console.log(getColors(product))
  //     // product.variations.map((item, index) => {
  //     //     console.log(item.attributes.attribute_pa_color)
  //     // })
  //     setProductData(product)
  //     // console.log("sdsd", getColors(product));
  // }, [])
  ...
  }, "Price: ", productData.variations[selectedProductID].display_price), __jsx("div", {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80,
  ...
  }, "Color: ", __jsx(ChooseColor, {
    onClick: function onClick() {
      return setSelectedProduct(productData.variations.variation_id);
    },
    colors: getColors(productData),
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 80,
  ...
  }), productData.variations[selectedProductID].variation_gallery_images.map(function (product, index) {
    return __jsx("img", {
...
//# sourceMappingURL=[single-product].js.60d01a24837ddfb21d99.hot-update.js.map