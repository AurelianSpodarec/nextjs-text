...
function SingleProduct(_ref) {
  ...
  console.log("Product", product, product[0].images.src);
  return __jsx("div", {
    __self: this,
    __source: {
  ...
  }, "Price: ", product[0].price), __jsx(_material_ui_core_CardMedia__WEBPACK_IMPORTED_MODULE_4__["default"], {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          query = ctx.query;
          console.log("Query Single Product", query['single-product']); // return WooCommerce.get(`products/${ctx.query['single-product']}`)

          return _context.abrupt("return", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_7__["default"].get("products/?slug=".concat(ctx.query['single-product'])).then(function (response) {
            return {
...
//# sourceMappingURL=[single-product].js.7943961694d52bf3d144.hot-update.js.map