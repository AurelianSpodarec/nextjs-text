...
function SingleProduct(_ref2) {
  ...
  return __jsx("div", {
    ...
    }, "console.log(\"Sd\", object) // Need to loop only attributes that are also green, right not it loops all", __jsx("div", {
      style: {
        height: '50px',
        width: '50px',
...
//# sourceMappingURL=[single-product].js.9df52d950d00aeb778dc.hot-update.js.map