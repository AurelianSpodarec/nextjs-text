  ...
  function getColor() {
    product.variations.map(function (object, index) {
      ...
      if (obj.includes(object.attributes.attribute_pa_color) === false) {
        ...
        (_console = console).log.apply(_console, obj.concat([object.attributes.attribute_pa_color]));

        obj.push.apply(obj, obj.concat([object.attributes.attribute_pa_color]));
      }
...
//# sourceMappingURL=[single-product].js.6412b5a1f196fdac7356.hot-update.js.map