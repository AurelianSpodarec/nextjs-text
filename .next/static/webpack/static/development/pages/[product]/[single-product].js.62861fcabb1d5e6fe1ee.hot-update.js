    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          return _context.abrupt("return", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_7__["default"].get("/wp-json/route/v1/product/slug=".concat(ctx.query['single-product'], "/v1?_json=callback")) // return WooCommerce.get(`products/${ctx.query['single-product']}`)
...
//# sourceMappingURL=[single-product].js.62861fcabb1d5e6fe1ee.hot-update.js.map