...
function SingleProduct(_ref2) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])('L'),
  ...
  console.log("clolors", colors);

  function getColor() {
    product.variations.map(function (object, index) {
      console.log("ddd", colors.includes(object.attributes.attribute_pa_color));
      console.log('colros', colors, obj);
      var obj = [];

      if (obj.includes(object.attributes.attribute_pa_color) === false) {
        console.log(object.attributes.attribute_pa_color);
        obj.push(function (obj) {
          return [].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(obj), [object.attributes.attribute_pa_color]);
        });
      }
...
//# sourceMappingURL=[single-product].js.7f3884d5249a78c1ac7e.hot-update.js.map