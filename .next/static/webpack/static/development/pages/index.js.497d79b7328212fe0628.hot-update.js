...
function Index(_ref) {
  ...
  return __jsx("div", {
    ...
    return (// <Link as={`/product/${product.id}`} href="/[product]/[single-product]">
      __jsx(_components__WEBPACK_IMPORTED_MODULE_5__["Product"], {
        key: index,
        product: product,
        __self: _this,
        __source: {
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          return _context.abrupt("return", _services_woocommerce_config_woocommerce__WEBPACK_IMPORTED_MODULE_6__["default"].get("products").then(function (response) {
            return {
...
//# sourceMappingURL=index.js.497d79b7328212fe0628.hot-update.js.map